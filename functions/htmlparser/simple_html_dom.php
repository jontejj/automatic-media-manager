...
class simple_html_dom_node {
    ...
    function nodetext()
    {
        ...
        foreach($this->nodes as $n)
        {
        	if (isset($n->_[HDOM_INFO_INNER])) 
        		$ret .= $n->_[HDOM_INFO_INNER];
	        else if($n->nodetype == HDOM_TYPE_TEXT)  
	        	$ret .= $n->dom->restore_noise($n->_[HDOM_INFO_TEXT]);
	    }
        return $ret;	
    }
    ...
    function __get($name) {
        ...
        switch($name) {
            ...
            case 'nodetext': return $this->nodetext();
